...
import { copyLibraryActToProject } from "@/lib/builder/companyLibrary";
...
export async function POST(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    const act = await copyLibraryActToProject(access.companyId, id, access.projectId, access.userId);
